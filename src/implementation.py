...
from src.mitm_interface import MitmUser, MitmVisitenKarte
...
def _v1_registration(flow: HTTPFlow):
    ...
    reg_info = json.loads(api.options.registration_info)
    ...
    user_registration_info.registrationId = req["registrationId"]
    user_registration_info.pniRegistrationId = req["pniRegistrationId"]
    user_registration_info.unidentifiedAccessKey = req["unidentifiedAccessKey"]
    ...
    api.options.registration_info = json.dumps(reg_info, default=utils.dataclass_to_json)
