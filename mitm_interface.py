...
from signal_protocol import curve, state, storage, protocol, session_cipher, session, kem
...
class MitmUser:
    def __init__(self, *args, **kwargs):
        ...
        self.identity_key_pair: IdentityKeyPair = kwargs.get("identity_key", IdentityKeyPair.generate())
    ...
    def process_pre_key_bundle(self, address: ProtocolAddress, pre_key_bundle: state.PreKeyBundle):
