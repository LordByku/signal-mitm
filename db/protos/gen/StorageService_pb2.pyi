...
class WriteOperation(_message.Message):
    ...
    def __init__(
        self,
        manifest: _Optional[_Union[StorageManifest, _Mapping]] = ...,
        insertItem: _Optional[_Iterable[_Union[StorageItem, _Mapping]]] = ...,
        deleteKey: _Optional[_Iterable[bytes]] = ...,
        clearAll: bool = ...,
    ) -> None: ...
...
class ManifestRecord(_message.Message):
    ...
    class Identifier(_message.Message):
        ...
        def __init__(
            self, raw: _Optional[bytes] = ..., type: _Optional[_Union[ManifestRecord.Identifier.Type, str]] = ...
        ) -> None: ...
    ...
    def __init__(
        ...
        sourceDevice: _Optional[int] = ...,
        identifiers: _Optional[_Iterable[_Union[ManifestRecord.Identifier, _Mapping]]] = ...,
    ) -> None: ...
...
class StorageRecord(_message.Message):
    ...
    def __init__(
        self,
        contact: _Optional[_Union[ContactRecord, _Mapping]] = ...,
        groupV1: _Optional[_Union[GroupV1Record, _Mapping]] = ...,
        groupV2: _Optional[_Union[GroupV2Record, _Mapping]] = ...,
        account: _Optional[_Union[AccountRecord, _Mapping]] = ...,
        storyDistributionList: _Optional[_Union[StoryDistributionListRecord, _Mapping]] = ...,
        callLink: _Optional[_Union[CallLinkRecord, _Mapping]] = ...,
    ) -> None: ...
...
class ContactRecord(_message.Message):
    ...
    def __init__(
        ...
        e164: _Optional[str] = ...,
        pni: _Optional[str] = ...,
        profileKey: _Optional[bytes] = ...,
        identityKey: _Optional[bytes] = ...,
        identityState: _Optional[_Union[ContactRecord.IdentityState, str]] = ...,
        givenName: _Optional[str] = ...,
        familyName: _Optional[str] = ...,
        username: _Optional[str] = ...,
        blocked: bool = ...,
        whitelisted: bool = ...,
        archived: bool = ...,
        markedUnread: bool = ...,
        mutedUntilTimestamp: _Optional[int] = ...,
        hideStory: bool = ...,
        unregisteredAtTimestamp: _Optional[int] = ...,
        systemGivenName: _Optional[str] = ...,
        systemFamilyName: _Optional[str] = ...,
        systemNickname: _Optional[str] = ...,
        hidden: bool = ...,
        pniSignatureVerified: bool = ...,
        nickname: _Optional[_Union[ContactRecord.Name, _Mapping]] = ...,
        note: _Optional[str] = ...,
    ) -> None: ...
...
class GroupV2Record(_message.Message):
    ...
    def __init__(
        ...
        dontNotifyForMentionsIfMuted: bool = ...,
        hideStory: bool = ...,
        storySendMode: _Optional[_Union[GroupV2Record.StorySendMode, str]] = ...,
    ) -> None: ...
...
class AccountRecord(_message.Message):
    ...
    class PinnedConversation(_message.Message):
        ...
        def __init__(
            self,
            contact: _Optional[_Union[AccountRecord.PinnedConversation.Contact, _Mapping]] = ...,
            legacyGroupId: _Optional[bytes] = ...,
            groupMasterKey: _Optional[bytes] = ...,
        ) -> None: ...
    ...
    class UsernameLink(_message.Message):
        ...
        def __init__(
            self,
            entropy: _Optional[bytes] = ...,
            serverId: _Optional[bytes] = ...,
            color: _Optional[_Union[AccountRecord.UsernameLink.Color, str]] = ...,
        ) -> None: ...
    ...
    def __init__(
        ...
        noteToSelfMarkedUnread: bool = ...,
        linkPreviews: bool = ...,
        phoneNumberSharingMode: _Optional[_Union[AccountRecord.PhoneNumberSharingMode, str]] = ...,
        unlistedPhoneNumber: bool = ...,
        pinnedConversations: _Optional[_Iterable[_Union[AccountRecord.PinnedConversation, _Mapping]]] = ...,
        preferContactAvatars: bool = ...,
        payments: _Optional[_Union[Payments, _Mapping]] = ...,
        universalExpireTimer: _Optional[int] = ...,
        primarySendsSms: bool = ...,
        e164: _Optional[str] = ...,
        preferredReactionEmoji: _Optional[_Iterable[str]] = ...,
        subscriberId: _Optional[bytes] = ...,
        subscriberCurrencyCode: _Optional[str] = ...,
        displayBadgesOnProfile: bool = ...,
        subscriptionManuallyCancelled: bool = ...,
        keepMutedChatsArchived: bool = ...,
        hasSetMyStoriesPrivacy: bool = ...,
        hasViewedOnboardingStory: bool = ...,
        storiesDisabled: bool = ...,
        storyViewReceiptsEnabled: _Optional[_Union[OptionalBool, str]] = ...,
        hasSeenGroupStoryEducationSheet: bool = ...,
        username: _Optional[str] = ...,
        hasCompletedUsernameOnboarding: bool = ...,
        usernameLink: _Optional[_Union[AccountRecord.UsernameLink, _Mapping]] = ...,
        backupsSubscriberId: _Optional[bytes] = ...,
        backupsSubscriberCurrencyCode: _Optional[str] = ...,
    ) -> None: ...
...
class StoryDistributionListRecord(_message.Message):
    ...
    def __init__(
        self,
        identifier: _Optional[bytes] = ...,
        name: _Optional[str] = ...,
        recipientServiceIds: _Optional[_Iterable[str]] = ...,
        deletedAtTimestamp: _Optional[int] = ...,
        allowsReplies: bool = ...,
        isBlockList: bool = ...,
    ) -> None: ...
...
class CallLinkRecord(_message.Message):
    ...
    def __init__(
        self,
        rootKey: _Optional[bytes] = ...,
        adminPasskey: _Optional[bytes] = ...,
        deletedAtTimestampMs: _Optional[int] = ...,
    ) -> None: ...
