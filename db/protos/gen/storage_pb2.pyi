...
class SessionStructure(_message.Message):
    ...
    class Chain(_message.Message):
        ...
        class MessageKey(_message.Message):
            ...
            def __init__(
                self,
                index: _Optional[int] = ...,
                cipher_key: _Optional[bytes] = ...,
                mac_key: _Optional[bytes] = ...,
                iv: _Optional[bytes] = ...,
            ) -> None: ...
        ...
        def __init__(
            self,
            sender_ratchet_key: _Optional[bytes] = ...,
            sender_ratchet_key_private: _Optional[bytes] = ...,
            chain_key: _Optional[_Union[SessionStructure.Chain.ChainKey, _Mapping]] = ...,
            message_keys: _Optional[_Iterable[_Union[SessionStructure.Chain.MessageKey, _Mapping]]] = ...,
        ) -> None: ...
    ...
    class PendingPreKey(_message.Message):
        ...
        def __init__(
            self,
            pre_key_id: _Optional[int] = ...,
            signed_pre_key_id: _Optional[int] = ...,
            base_key: _Optional[bytes] = ...,
    ...
    def __init__(
        self,
        session_version: _Optional[int] = ...,
        local_identity_public: _Optional[bytes] = ...,
        remote_identity_public: _Optional[bytes] = ...,
        root_key: _Optional[bytes] = ...,
        previous_counter: _Optional[int] = ...,
        sender_chain: _Optional[_Union[SessionStructure.Chain, _Mapping]] = ...,
        receiver_chains: _Optional[_Iterable[_Union[SessionStructure.Chain, _Mapping]]] = ...,
        pending_pre_key: _Optional[_Union[SessionStructure.PendingPreKey, _Mapping]] = ...,
        pending_kyber_pre_key: _Optional[_Union[SessionStructure.PendingKyberPreKey, _Mapping]] = ...,
        remote_registration_id: _Optional[int] = ...,
        local_registration_id: _Optional[int] = ...,
        alice_base_key: _Optional[bytes] = ...,
    ) -> None: ...
...
class RecordStructure(_message.Message):
    ...
    def __init__(
        self,
        current_session: _Optional[_Union[SessionStructure, _Mapping]] = ...,
        previous_sessions: _Optional[_Iterable[bytes]] = ...,
    ) -> None: ...
...
class PreKeyRecordStructure(_message.Message):
    ...
    private_key: bytes
    def __init__(
        self, id: _Optional[int] = ..., public_key: _Optional[bytes] = ..., private_key: _Optional[bytes] = ...
    ) -> None: ...
...
class SenderKeyStateStructure(_message.Message):
    ...
    def __init__(
        self,
        message_version: _Optional[int] = ...,
        chain_id: _Optional[int] = ...,
        sender_chain_key: _Optional[_Union[SenderKeyStateStructure.SenderChainKey, _Mapping]] = ...,
        sender_signing_key: _Optional[_Union[SenderKeyStateStructure.SenderSigningKey, _Mapping]] = ...,
        sender_message_keys: _Optional[_Iterable[_Union[SenderKeyStateStructure.SenderMessageKey, _Mapping]]] = ...,
    ) -> None: ...
...
class SenderKeyRecordStructure(_message.Message):
    ...
    def __init__(
        self, sender_key_states: _Optional[_Iterable[_Union[SenderKeyStateStructure, _Mapping]]] = ...
    ) -> None: ...
