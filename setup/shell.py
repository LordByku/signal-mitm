...
def execute(cmd, retcodes: tuple[int, ...] = None, sudo=False, log=False):
    """
    ...
    def log_command():
        if log:
            ...
            logging.info(f"function:{inspect.currentframe().f_back.f_back.f_code.co_name}, line {inspect.currentframe().f_back.f_back.f_lineno} \n{cmd} {formatstring_stdout(stdout)}")
